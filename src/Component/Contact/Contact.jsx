...
//         e.preventDefault();
//         emailjs.sendForm("service_upjk8ot","template_fml98jl",e.target,"QOKq2FbivQC0D2LPs").then(res=>{console.log(res)}).catch(err=>{console.log(err)});
//         console.log("kjfbdsjsb");
//     }
...
//                 <button onSubmit={sendemail}><h6>CONTACT</h6></button>
